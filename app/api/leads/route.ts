  ...
  try {
    ...
    try {
      ...
      const backendPayload = {
        ...
        service_details: newLead.service_details,
        ...
        first_utm_source: newLead.first_utm_source,
        first_utm_medium: newLead.first_utm_medium,
        first_utm_campaign: newLead.first_utm_campaign,
        first_landing_page: newLead.first_landing_page,
        first_referrer: newLead.first_referrer,
        first_touch_time: newLead.first_touch_time,
        last_utm_source: newLead.last_utm_source,
        last_utm_medium: newLead.last_utm_medium,
        last_utm_campaign: newLead.last_utm_campaign,
        last_landing_page: newLead.last_landing_page,
        last_referrer: newLead.last_referrer,
        last_touch_time: newLead.last_touch_time,
        event_id: newLead.event_id,
        file_name: newLead.file_name,
        file_size: newLead.file_size,
        file_type: newLead.file_type,
        priority: newLead.priority,
        lead_score: newLead.lead_score,
        score_reasons: newLead.score_reasons,
